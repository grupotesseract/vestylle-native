    ...
    <View style={{alignSelf: 'stretch'}}>
      ...
      <View style={{alignItems: 'flex-start', alignSelf: 'stretch', textAlign: 'left', marginTop: 20}}>
        { this.state.qtdPontos === 0 ? (<>
          ...
          <RubikText style={{color: 'white'}}> Para começar a acumular pontos, insira seu CPF em Meu Perfil e utilize-o nas próximas compras na loja Vestylle Megastore Jaú. Seus pontos aparecerão aqui. </RubikText>
        </>) :
